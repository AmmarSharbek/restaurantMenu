...
class TenantProfileRequest extends FormRequest
{
    ...
    {
        return [
            'nameTenant.required' => new ValidationErrorCode(ValidationErrorCode::Required),
            'nameTenant.max' => new ValidationErrorCode(ValidationErrorCode::MaxLength255),
        ];
    }
